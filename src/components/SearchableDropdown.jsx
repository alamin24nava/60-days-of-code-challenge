...
import {getTagsByName, useTagsSelector } from "../features/tags/tagsSlice"
            ...
            <div onClick={handleSeleteTag} className="border p-4 rounded-md mb-4">-- Select Tags --</div> 
                ...
                <div className={open ? 'border p-4 mt-2 rounded-md block' : 'border mt-2 rounded-md h-0 hidden'}>
                    <div className="w-full mb-4">
                        <input type="text" value={changeTagName} onChange={handleFilterTag} placeholder="Search Or Create Tags..." className="input input-bordered w-full" />
                    </div>
